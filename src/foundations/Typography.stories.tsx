...
const textStyles: TypeStyle[] = [
  { name: 'Display', className: 'text-display', usage: 'Hero / marketing headlines. Use once per view.' },
  { name: 'Heading 1', className: 'text-h1', usage: 'Page titles.' },
  { name: 'Heading 2', className: 'text-h2', usage: 'Major section titles.' },
  { name: 'Heading 3', className: 'text-h3', usage: 'Sub-section titles.' },
  ...
  { name: 'Label', className: 'text-label', usage: 'Form labels and inline emphasis (used by Label, Field…).' },
  ...
  { name: 'Overline', className: 'text-overline uppercase', usage: 'Eyebrow labels above a title; rendered uppercase.', sample: 'SECTION LABEL' },
    ...
    <Page
      ...
      intro={
        <>
          ...
          <code className="font-mono">--font-mono</code>). Specs below are measured live from each sample.
        </>
      }
    >
      <Section

...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "grid min-w-32 items-start gap-6px rounded-lg border border-border/50 bg-background px-10px py-6px text-caption shadow-xl",
        className
      )}
    >
          ...
          .map((item, index) => {
            ...
            return (
              <div
                key={index}
                className={cn(
                  "flex w-full flex-wrap items-stretch gap-8px [&>svg]:h-2.5 [&>svg]:w-2.5 [&>svg]:text-muted-foreground",
        ...
        .map((item, index) => {
          ...
          return (
            <div
              key={index}
              className={cn(
                "flex items-center gap-6px [&>svg]:h-3 [&>svg]:w-3 [&>svg]:text-muted-foreground"
              )}
            >

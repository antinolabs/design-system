...
const surfaceSwatches = [
  ...
  { token: 'surface-strong', className: 'bg-surface-strong' },
      ...
      examples: [
        {
          title: 'Surfaces & text',
          node: (
            <div className="grid w-full max-w-2xl grid-cols-2 gap-16px sm:grid-cols-4">
        ...
        },
        {
          title: 'Brand & intents',
          node: (
            <div className="grid w-full max-w-2xl grid-cols-2 gap-16px sm:grid-cols-3">
              {brandSwatches.map((s) => (
                <Swatch key={s.token} token={s.token} className={s.className} />
              ))}
            </div>
